...
VIEW_SOURCE = ROOT / "Sources" / "dok" / "DokWheelView.swift"
WINDOW_SOURCE = ROOT / "Sources" / "dok" / "DokWheelWindow.swift"
...
def main() -> None:
    ...
    requirements = [
        ...
        ("static let glassSamplerWarmupDelay: Double = 0.024", "one-frame native sampler warmup"),
        ("static let windowRevealDuration: Double = 0.12", "short window reveal timing"),
        ("static let windowWarmupAlpha: CGFloat = 0.01", "nonzero warmup alpha keeps desktop sampling active"),
    ...
    window_requirements = [
        ...
        ("self.animator().alphaValue = 1", "window reaches full opacity through AppKit animation"),
